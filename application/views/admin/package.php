                ...
                <table class="table table-hover table-stripe">
                    <tbody>
                        <thead class="thead-dark">
                          <tr>
                              <td width="30%"><h3 class="font-weight-normal"><?php echo trans('manage-packages') ?></h3></td>
                              <?php $i=1; foreach ($packages as $package): ?>
                                <td class="text-center">
                                  ...
                                  <p class="mb-15 fs-20"><?php echo currency_to_symbol(settings()->currency); ?><?php echo round($package->price); ?>  <span class="fs-14">per year</span> <br> <?php echo currency_to_symbol(settings()->currency); ?><?php echo round($package->monthly_price); ?>  <span class="fs-14"> <?php echo trans('per-month') ?></p>
