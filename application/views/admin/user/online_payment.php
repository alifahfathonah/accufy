                ...
                <form method="post" enctype="multipart/form-data" class="validate-form" action="<?php echo base_url('admin/payment/online/2/'.md5($invoice->id))?>" role="form">
                    <div class="box">
                        <div class="box-header">
                            <h4 class="box-title" id="vcenter"><?php echo trans('pay-online') ?>  -  <?php if(!empty($currency_symbol)){echo html_escape($currency_symbol);} ?><?php echo $invoice->grand_total - get_total_invoice_payments($invoice->id, $invoice->parent_id); ?></h4>
                        </div>
                        <div class="box-body">
                            <div class="form-group">
                                <label><?php echo trans('amount') ?> <span class="text-danger">*</span></label>
                                <input type="text" class="form-control" name="amount" value="<?php echo $invoice->grand_total - get_total_invoice_payments($invoice->id, $invoice->parent_id); ?>">
