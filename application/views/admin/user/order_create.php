                              ...
                              <div class="panel-body inv">                      
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <?php else: ?>
                                            <input type="text" class="form-control text-right" name="title" value="<?php echo trans('bill') ?> <?php echo get_invoice_number(3); ?>">
                                        <?php endif ?>
                                    ...
                                    <div class="col-xs-6 col-md-8 text-right">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-4">
                                                ...
                                                <?php else: ?>
                                                    <input type="text" class="form-control" name="number" value="<?php echo date('Y').'-'.str_pad(get_invoice_number(3), 2, '0', STR_PAD_LEFT); ?>">
                                                <?php endif ?>
                                            </div>
                                        </div>
