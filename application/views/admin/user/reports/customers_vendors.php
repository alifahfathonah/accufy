                              ...
                              <div class="col-md-4 col-xs-12 pl-0 mb-5 mt-5">
                                  <select class="form-control single_select" name="customer">
                                      ...
                                      <?php foreach ($users as $customer): ?>
                                        <option value="<?php echo html_escape($customer->customer) ?>" <?php echo(isset($_GET['customer']) && $_GET['customer'] == $customer->customer) ? 'selected' : ''; ?>
                  ...
                  <tbody>
                    ...
                    <?php $i=1; foreach ($users as $user): ?>
                      <tr id="row_<?php echo html_escape($user->customer); ?>">
                          ...
                          <td class="text-right"><?php echo $this->business->currency_code.' '. number_format(get_incomes_by_customer($user->customer), 2); ?></td>
