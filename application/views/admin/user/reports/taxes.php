                  ...
                  <tbody>
                    ...
                    <?php $i=1; foreach ($taxes as $tax): ?>
                      <tr id="row_<?php echo html_escape($tax->id); ?>">
                          ...
                          <td>
                            <?php $total_sale = 0; foreach ($tax->type as $type): ?>
                              <?php foreach ($type->sales as $sale): ?>
                                <?php $total_sale += $sale->convert_total; ?>
                              <?php endforeach ?>
                            <?php endforeach ?>
                          ...
                          <td>
                            <?php $sale_tax = $total_sale*$tax->rate/100; ?>
                            <?php echo $this->business->currency_code.' '.number_format($sale_tax, 2); ?>
                          </td>

                          <td>
                            <?php $total_purchase = 0; foreach ($tax->type as $type): ?>
                              <?php foreach ($type->purchases as $purchase): ?>
                                <?php $total_purchase += $purchase->convert_total; ?>
                              <?php endforeach ?>
                            <?php endforeach ?>
                          ...
                          <td>
                            <?php $purchase_tax = $total_purchase*$tax->rate/100; ?>
