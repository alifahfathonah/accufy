                                            ...
                                            <tr class="btom">
                                                ...
                                                <?php $b=1; foreach ($packages as $package): ?>
                                                  <td class="<?php if($b==2){echo"colm_2";} ?>">
                                                      <a class="price_package_btn custom-btn custom-btn--medium custom-btn--style-<?php if($b==2){echo"2";}else{echo "3";} ?>" href="<?php echo base_url('register?plan='.$package->slug) ?>"><?php echo trans('get-started') ?></a>
                                                  </td>
                                                <?php $b++; endforeach; ?>
                                            </tr>
                                        </tfoot>
